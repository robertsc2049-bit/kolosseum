...
4. `docs/product/FULL_UI_GAP_REPORT.md` is the generated UI-completion report. Its current result is 337 implemented, zero partial, zero missing, and zero prohibited.
