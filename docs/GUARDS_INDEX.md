...
| `ci/guards/s_reg_25_equipment_registry_activation_guard.mjs` | Registry Law | high | registry | No other candidate domain's active-file counterpart may ever appear here - |
