...
| `ci/guards/s_reg_33_exercise_activity_applicability_registry_activation_guard.mjs` | Registry Law | high | registry | No other candidate domain's active-file counterpart may ever appear here - |
| `ci/guards/s_reg_34_exercise_reference_media_schema_extension_guard.mjs` | Registry Law | high | registry | Unlike every S-REG content-mutation slice, this schema-only extension must |
...
| `ci/guards/s_v1_p_06_device_sync_contract_ingestion_guard.mjs` | Repo Governance | medium | repo |  |
