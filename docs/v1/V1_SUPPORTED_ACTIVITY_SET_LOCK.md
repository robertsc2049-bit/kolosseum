...
No other activity is active in v1 unless a later named boundary-change slice deliberately replaces this record and updates all linked guards, fixtures, tests, and release-boundary records. (Strongman, hyrox, crossfit, and street_lifting were added by such amendments - see docs/roadmap/V1_SUPPORTED_ACTIVITIES_DECISION.md.)
...
- the supported set is exactly powerlifting, general_strength, rugby_union, strongman, hyrox, crossfit, and street_lifting
