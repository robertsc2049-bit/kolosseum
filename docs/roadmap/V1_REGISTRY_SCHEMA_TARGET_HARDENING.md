...
The locked activity set is now powerlifting, general_strength, rugby_union, strongman, hyrox, and crossfit, per the amendment recorded in docs/roadmap/V1_SUPPORTED_ACTIVITIES_DECISION.md.

## Amendment - Street lifting activated as v1's seventh locked activity

The locked activity set is now powerlifting, general_strength, rugby_union, strongman, hyrox, crossfit, and street_lifting, per the amendment recorded in docs/roadmap/V1_SUPPORTED_ACTIVITIES_DECISION.md.
