...
The locked activity set is now powerlifting, general_strength, rugby_union, strongman, hyrox, crossfit, and rugby_league, per the amendment recorded in docs/roadmap/V1_SUPPORTED_ACTIVITIES_DECISION.md.
