...
The locked activity set is now exactly powerlifting, general_strength, rugby_union, strongman, hyrox, crossfit, and street_lifting (length 7), per the amendment recorded in docs/roadmap/V1_SUPPORTED_ACTIVITIES_DECISION.md. ci/guards/v1_locked_activity_set_guard.mjs's `expectedActivities` was updated accordingly.
