// DEV NOTE: FULL-UI-67 - programme template marketplace visibility. A
// coach declares one of their own complete/active templates publicly
// browsable by every other coach - browse only, no cloning or
// cross-coach assignment in this slice. This is a wholly separate,
// additive record type - it does not touch beta18_programme_template's
// own field contract, and ownership/status are re-verified against the
// live template on every save and every browse read, never trusted from
// a stale sharing record.
...
import { listCoachProgrammeTemplates } from "./beta18_programme_template_service.js";
...
export async function saveProgrammeTemplateSharingPreference(
  ...
  const recordWithoutHash = {
    ...
    contract_version: "full_ui_67.1.0.0",
