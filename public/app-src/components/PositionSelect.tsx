...
// a real position list, the other 6 each get a single generic "Athlete"
// option. A single <select>, unlike TrainingFocusCheckboxes.tsx's
// checkboxes - position is exactly one value, not zero-or-more.
