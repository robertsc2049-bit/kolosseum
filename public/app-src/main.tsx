...
mount("attendance-event-create-root", <AttendanceEventCreatePanel />);
mount("attendance-event-detail-root", <AttendanceEventDetailPanel />);
mount("athlete-attendance-events-root", <AthleteAttendanceEventsPanel />);
