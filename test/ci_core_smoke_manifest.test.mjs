...
test("package.json matches pinned core smoke CI manifest", () => {
  ...
  assert.ok(cluster.length > 0, "expected non-empty core smoke cluster manifest");
  ...
  assert.deepEqual(
    ...
    cluster,
    "expected core smoke manifest cluster to be adjacent with no inserted commands"
  );
});