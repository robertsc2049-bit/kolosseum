...
test("compile runtime trace cluster CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected compile runtime trace cluster CI manifest to be valid JSON");
