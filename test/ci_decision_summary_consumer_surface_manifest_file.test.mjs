...
test("decision summary consumer surface CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected decision summary consumer surface CI manifest to be valid JSON");
