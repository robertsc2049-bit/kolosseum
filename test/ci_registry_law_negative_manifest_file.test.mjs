...
test("registry law negative CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected registry law negative CI manifest to be valid JSON");
