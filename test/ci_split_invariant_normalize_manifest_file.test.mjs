...
test("split invariant normalize CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected split invariant normalize CI manifest to be valid JSON");
