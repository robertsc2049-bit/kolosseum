...
test("phase6 unsupported-activity contract CI cluster manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  const repo = process.cwd();
  const manifestPath = path.join(repo, "ci", "contracts", "phase6_unsupported_activity_contract_ci_cluster.json");
