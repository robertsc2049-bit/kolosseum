...
test("dev session API cluster CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected dev session API cluster CI manifest to be valid JSON");
