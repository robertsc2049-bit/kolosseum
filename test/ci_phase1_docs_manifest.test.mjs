...
test("phase1 docs manifest remains present in composed test:ci command set", () => {
  ...
  assert.ok(manifest.cluster.length > 0, "expected non-empty phase1 docs cluster manifest");
