...
test("registry law positive manifest remains present in composed test:ci command set", () => {
  ...
  assert.ok(manifest.cluster.length > 0, "expected non-empty registry law positive cluster manifest");
