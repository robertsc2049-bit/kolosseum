...
test("phase1 truth surface CI cluster manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  const repo = process.cwd();
  const manifestPath = path.join(repo, "ci", "contracts", "phase1_truth_surface_ci_cluster.json");
