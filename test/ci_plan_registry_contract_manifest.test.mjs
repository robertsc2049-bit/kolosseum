...
test("plan registry contract manifest remains present in composed test:ci command set", () => {
  ...
  assert.ok(manifest.cluster.length > 0, "expected non-empty plan registry contract cluster manifest");
