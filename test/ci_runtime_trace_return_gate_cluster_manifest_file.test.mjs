...
test("runtime trace return gate cluster CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected runtime trace return gate cluster CI manifest to be valid JSON");
