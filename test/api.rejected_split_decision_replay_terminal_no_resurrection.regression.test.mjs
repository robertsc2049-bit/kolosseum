...
test("API regression: rejected split-decision replay preserves terminal-state shape and no-resurrection invariants across cache clear", async (t) => {
  ...
  assertNoResurrection(stateAfterSkip.json, splitRemainingIds, "after RETURN_SKIP");
  ...
  assertNoResurrection(stateAfterReplayReject.json, splitRemainingIds, "after rejected replay");
  ...
  assertNoResurrection(stateAfterClear.json, splitRemainingIds, "after cache clear");
