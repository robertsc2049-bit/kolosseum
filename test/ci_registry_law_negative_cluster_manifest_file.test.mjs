...
test("registry law negative cluster CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected registry law negative cluster CI manifest to be valid JSON");
