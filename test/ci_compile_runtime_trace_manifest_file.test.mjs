...
test("compile runtime trace CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected compile runtime trace CI manifest to be valid JSON");
