...
test("split invariant normalize cluster CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected split invariant normalize cluster CI manifest to be valid JSON");
