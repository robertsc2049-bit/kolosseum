...
test("registry law positive CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected registry law positive CI manifest to be valid JSON");
