...
test("decision summary consumer surface cluster CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected decision summary consumer surface cluster CI manifest to be valid JSON");
