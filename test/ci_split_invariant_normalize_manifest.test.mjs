...
test("split invariant normalize manifest remains present in composed test:ci command set", () => {
  ...
  assert.ok(manifest.cluster.length > 0, "expected non-empty split invariant normalize cluster manifest");
