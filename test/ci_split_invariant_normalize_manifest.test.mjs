...
test("package.json matches pinned split invariant normalize CI manifest", () => {
  ...
  assert.deepEqual(
    ...
    cluster,
    "expected split invariant normalize manifest cluster to be adjacent with no inserted commands"
  );
});