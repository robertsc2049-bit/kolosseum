...
test("runtime trace return gate CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected runtime trace return gate CI manifest to be valid JSON");
