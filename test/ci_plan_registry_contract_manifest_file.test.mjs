...
test("plan registry contract CI manifest file is well-formed, non-empty, unique, and node-test-only", () => {
  ...
  }, "expected plan registry contract CI manifest to be valid JSON");
