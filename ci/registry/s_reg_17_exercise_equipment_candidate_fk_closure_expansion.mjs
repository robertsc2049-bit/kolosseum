...
function assertActiveRegistrySurface() {
  ...
  assertExactArray(registryIndex.order, S_REG_17_ACTIVE_REGISTRY_ORDER, "active_registry_index_order_changed");
  assertExactArray(Object.keys(registryBundle.registries ?? {}), S_REG_17_ACTIVE_REGISTRY_ORDER, "active_registry_bundle_changed");
}
