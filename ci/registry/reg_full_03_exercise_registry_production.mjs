...
export const EXPECTED_EXERCISE_COUNT = 215;
export const EXPECTED_TOKEN_COUNT = 4;
export const EXPECTED_APPLICABILITY_COUNT = 1785;
...
export const EXPECTED_ACTIVITY_COUNTS = Object.freeze({ powerlifting: 165, general_strength: 215, rugby_union: 215 });
