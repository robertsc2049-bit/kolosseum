...
export const EXPECTED_ACTIVITY_COUNTS = Object.freeze({ powerlifting: 176, general_strength: 238, rugby_union: 237, strongman: 25, hyrox: 12, crossfit: 19, rugby_league: 237 });
export const EXPECTED_ACTIVITY_PATTERN_COUNTS = Object.freeze({ powerlifting: 41, general_strength: 54, rugby_union: 54, strongman: 8, hyrox: 6, crossfit: 7, rugby_league: 54 });
